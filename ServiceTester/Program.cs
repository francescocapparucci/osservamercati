...
namespace ServiceTester
{
    ...
    class Program
    {
        ...
        {
            CervedWSHandler cTestHandler = new CervedWSHandler(
            "",
            "",
                "",
            ...
            int productCode = Convert.ToInt32(ConfigurationManager.AppSettings["GP_PRODUCTCODE"]);



            cTestHandler.BuyGlobalProfile("03468530369", 55200, 9,true);
        }
    }
}
